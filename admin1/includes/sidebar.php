                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="dashboard.php">
                                        ...
                                        <span class="font-size-xl text-dual-primary-dark">FW</span>|<span class="font-size-xl text-primary">FactChecker</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
...
$sql="SELECT AdminName from  tblfactu where ID=:aid";
