                                ...
                                <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                                    <nav>
                                        <ul class="nav navbar-nav">
                                            ...
                                            <li><a href="about.php"> <i class="fa fa-address-card-o"></i> About</a></li>
                                            ...
                                            <li><a href="mail.php"><i class="fa fa-envelope"></i> Mail Us</a></li>
                        ...
                        <div class="collapse navbar-collapse ">
                            <ul style="color: white;">
                                <li style="color: white;"><a href="login.php">Login</a></li>
											...
											<li style="color: white;" > <a  href="admin1/login.php">FactChecker</a></li>
                                            <li style="color: white;"><a href="admin/login.php">Admin</a></li>
                               <?php } ?>
                            </ul>
